  ...
  return (
    <div className="container mx-auto px-4 my-6 relative">
      ...
      <div className="flex items-center gap-4 md:gap-6 overflow-x-scroll scrollbar-none" ref={scrollElement}>
        ...
        <button
          onClick={scrollLeft}
          className="absolute left-0 top-1/2 transform -translate-y-1/2 text-lg md:text-2xl bg-coffee-light shadow-lg rounded-full p-2 md:p-3 z-20 transition-all hover:scale-110 hover:bg-coffee-brown text-white"
        >
          <FaAngleLeft />
        </button>
        ...
        <button
          onClick={scrollRight}
          className="absolute right-0 top-1/2 transform -translate-y-1/2 text-lg md:text-2xl bg-coffee-light shadow-lg rounded-full p-2 md:p-3 z-20 transition-all hover:scale-110 hover:bg-coffee-brown text-white"
        >
          <FaAngleRight />
        </button>
                ...
                <div className="p-4 grid gap-3">
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    {product?.sellingPrice !== product?.price && (
                      <p className="flex items-center font-sans justify-center bg-yellow-200 rounded-md p-1">
